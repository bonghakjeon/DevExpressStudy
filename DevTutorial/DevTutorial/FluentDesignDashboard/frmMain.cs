...
namespace FluentDesignDashboard
{
    public partial class frmMain : DevExpress.XtraBars.FluentDesignSystem.FluentDesignForm
    {
        ...
        {
            // 컨테이너(fluentDesignFormContainer1)에 DevExpress사용자 정의 컨트롤(UserControl - ucDashboard) 추가(Add)
            ...
            fluentDesignFormContainer1.Controls.Add(new ucDashboard() { Dock=DockStyle.Fill });  // 컨트롤(UserControl - ucDashboard)이 컨테이너(fluentDesignFormContainer1)에 Docking할 때, 컨테이너의 정 가운데로 Dokcing 설정(Dock=DockStyle.Fill)  
        }
    }
}
